		...
		<>
			<div className="space-y-4">
				...
				<h1 className="text-3xl font-bold sm:text-4xl md:text-6xl">
					Howdy, I'm{' '}
					<span className="text-blue-700 dark:text-white">{lanyard?.kv.nick ?? 'Suluh'}</span> 🙋‍♂️
				</h1>

				<p className="opacity-80">
					I'm a <span suppressHydrationWarning>~{age.toPrecision(7)}</span> year old Muslim software
					engineer from the {lanyard?.kv.country ?? 'Indonesia'}. I'm interested in backend stuff
					and Alhamdulillah have {new Date().getFullYear() - 2015}+ years experience in web
					development.
				</p>
			</div>
			...
			<div className="space-y-4">
				...
				<p className="opacity-80">
					...
					, we are always building something for the government and private companies. Bellow are
