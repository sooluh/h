...
import {FaDiscord, FaEnvelope, FaPaperPlane, FaPhoneAlt, FaTwitter} from 'react-icons/fa';
		...
		<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
			...
			<div>
				<ul className="list-inside list-disc space-y-2 pt-5 md:float-right">
					<ListItemReversed icon={FaEnvelope} text="touch@suluh.my.id" />
					<ListItemReversed
						icon={FaDiscord}
						text={
                lanyard ? (
	<span className="flex items-center space-x-1">
		...
		<span>
            ...
            />
					...
					<ListItemReversed icon={FaPhoneAlt} text={lanyard?.kv.phone ?? ''} />
				</ul>
			</div>
		</div>
	</div>
