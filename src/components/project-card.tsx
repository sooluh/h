...
export function ProjectCard({repo: project}: {repo: PinnedRepo}) {
  ...
  return (
    <motion.div
      ...
      className="relative flex flex-col overflow-hidden rounded-md border-white/10 bg-gradient-to-tr from-emerald-100 to-emerald-700/5 text-emerald-900/80 no-underline dark:border dark:from-white/5 dark:to-white/5 dark:text-neutral-100 dark:hover:bg-white/10 md:rounded-lg"
    >
      <button
        type="button"
